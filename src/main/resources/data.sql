-- Hotel Management System - Mock Data (30 records per table)
-- This script creates realistic sample data for all tables

-- Note: This uses UUIDs. Make sure uuid-ossp extension is enabled
...
-- ========================================
-- 4. ROOMS (30 records per hotel - will be generated)
-- ========================================
-- Note: This will create rooms for each hotel. We'll create a reasonable number per hotel.

-- ========================================
-- 5. EMPLOYEES (30 records)
-- ========================================
-- Note: Employees will reference hotels and roles created above
...
-- ========================================
-- Note: The following tables (Rooms, Employees, Bookings, Bills) require 
-- references to the above tables. They should be created using a script
-- that properly links the foreign keys. For production use, consider
-- creating a more sophisticated data generation script or using a tool
