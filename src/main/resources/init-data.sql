-- Hotel Management System - Initialization Script
-- Run this script manually in your PostgreSQL database or use a migration tool
-- Make sure uuid-ossp extension is enabled: CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
